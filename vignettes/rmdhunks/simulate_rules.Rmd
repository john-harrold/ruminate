...
with a short name for the system timescale. The next should be `details` which
is a list containing short names for each timescale you want to include. Each
of these is a list with a verbose name for the time scale (`verb`) and a
numerical conversion indicating how that timescale relates to the others. Here
