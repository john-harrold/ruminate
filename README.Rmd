...
You can install the development version from [GitHub](https://github.com/john-harrold/) with the following:
...
Note that because `ruminate` depends on `formods` you will need to first install the development version of `formods`.
